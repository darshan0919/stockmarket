...
1. Read skills/equity-research/investment-thesis-engine/SKILL.md plus its references/ (thesis_schema.md, signal_rules.md) and skills/_shared/data-verification.md. Follow them strictly.
2. Load every thesis: list files in the Google Drive folder "stockmarket-theses" (ID 1MKK_WjVcvKCodIUaosTCZ8d_HXz6JPpL) via the Google Drive connector; fall back to local data/theses/. If there are no {TICKER}_thesis.json files yet, reply "No theses on file yet — nothing to scan" and stop.
