...
Follow the `watchlist-insights` skill (stockmarket/skills/equity-research/watchlist-insights/SKILL.md) — read it from the local mounted repo path — with watchlistIds = 0a365ec2139aa6ca7f74c250,7ca0e1a60c3fd0d8b1ab61ce,51a196a79dbc0296493e5174 (Near Highs + Radar + Upcoming Results).
