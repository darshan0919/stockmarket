...
['admin', 'announcements', 'market', 'orders', 'research', 'results', 'screener', 'stock', 'twitter', 'watchlist'].forEach(f => fs.mkdirSync(path.join(featuresPath, f), { recursive: true }));
['config', 'middleware', 'utils', 'api'].forEach(f => fs.mkdirSync(path.join(corePath, f), { recursive: true }));
...
move('controllers/announcementsController.js', 'src/features/announcements/announcementsController.js');
move('controllers/declaredResultsController.js', 'src/features/results/declaredResultsController.js');
move('controllers/upcomingResult.js', 'src/features/results/upcomingResultController.js');
move('controllers/resultTranscriptController.js', 'src/features/results/resultTranscriptController.js');
...
move('controllers/researchDashboardController.js', 'src/features/research/researchDashboardController.js');
move('controllers/researchPipelineController.js', 'src/features/research/researchPipelineController.js');
...
move('services/announcementScanIgnoreStore.js', 'src/features/announcements/announcementScanIgnoreStore.js');
...
move('services/stockscansAnnouncementScan.js', 'src/features/announcements/stockscansAnnouncementScan.js');
move('services/stockscansAnnouncementScansPage.js', 'src/features/announcements/stockscansAnnouncementScansPage.js');
move('services/stockscansAnnouncements.js', 'src/features/announcements/stockscansAnnouncements.js');
...
function resolveRequire(requirePath, currentOldDir) {
    ...
    else if (!fs.existsSync(oldAbs) && fs.existsSync(path.join(oldAbs, 'index.js'))) oldAbs = path.join(oldAbs, 'index.js');
...
// Clean empty dirs
['controllers', 'routes', 'models', 'services', 'config', 'middleware', 'utils', 'api'].forEach(d => {
