...
mkdir -p data/management-credibility-tracker
bash ./skills/_shared/resolve.sh render-pdf --html report.html --pdf "data/management-credibility-tracker/<Company>_Output.pdf"
```
