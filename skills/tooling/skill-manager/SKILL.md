...
1. **Check Existing Dependencies**: Before writing scripts or adding functionalities, read the dependencies registry at [DEPENDENCIES.md](skills/registries/DEPENDENCIES.md) or [workflow-dependencies.json](skills/registries/workflow-dependencies.json). Identify if any existing skills, classes, API clients, or utilities can be reused or tweaked to fulfill the workflow requirements rather than rebuilding them.
...
Consult [DEPENDENCIES.md](skills/registries/DEPENDENCIES.md) or [workflow-dependencies.json](skills/registries/workflow-dependencies.json) to see if existing classes, APIs, utilities, or skills already provide the needed capabilities or can be slightly tweaked. This prevents duplicate logic.
