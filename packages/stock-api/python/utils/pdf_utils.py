...
Consumed by `deepdive/packages/stock-api/python/generators/generate_report.py` and
`growth-triggers-1pager/packages/stock-api/python/generators/generate_pdf.py`. Palette-agnostic helpers
