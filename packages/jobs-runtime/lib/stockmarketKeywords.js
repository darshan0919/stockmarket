...
const SEED = [
  // markets / instruments
  'company', 'business', 'finance', 'financial', 'market', 'sector', 'industry',
  'stock', 'share', 'shares', 'equity', 'equities', 'nse', 'bse', 'sebi', 'nifty',
  'sensex', 'ticker', 'isin', 'scrip', 'listing', 'exchange',
  // charts / technicals
  'chart', 'technical', 'candlestick', 'breakout', 'moving average', 'rsi',
  // primary docs / filings
  'drhp', 'rhp', 'ipo', 'prospectus', 'annual report', 'balance sheet', 'cash flow',
  'p&l', 'profit and loss', 'concall', 'con-call', 'earnings call', 'transcript',
  'investor presentation', 'quarterly', 'results', 'filing', 'filings',
  // valuation / fundamentals
  'valuation', 'pe ratio', 'p/e', 'ev/ebitda', 'ebitda', 'revenue', 'margin',
  'roce', 'roe', 'capex', 'capacity', 'order book', 'guidance', 'dividend',
  // research constructs
  'thesis', 'conviction', 'catalyst', 'pead', 'watchlist', 'portfolio', 'holdings',
  'forensic', 'credibility', 'management', 'promoter', 'pledge', 'peer', 'comparison',
  'market share', 'value chain', 'growth trigger', 'fundamental',
  // events / flows
  'gainers', 'losers', 'deal', 'bulk deal', 'block deal', 'sast', 'insider',
  'delivery', 'fii', 'dii', 'buyback', 'rights issue', 'qip', 'merger',
  'acquisition', 'demerger', 'mutual fund',
  // tools / vendors in this project
  'stockscans', 'screener', 'kite', 'zerodha', 'perplexity',
];
