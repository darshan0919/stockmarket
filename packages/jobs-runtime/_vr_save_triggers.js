...
const records = [
  ...
  },
  {
    ...
    summary: 'KPIT Technologies +3.64% on 27.9% delivery (₹95.5 Cr of ₹342.1 Cr traded, 3.1x volume). The "order_book"-tagged strong filing is actually a stamp-duty penalty disclosure (₹1.23 Cr) tied to the Birlasoft demerger scheme — not an order win; category tag is a mismatch. Concall 32 days old was Cautious (resultQualityScore 29): revenue -3.6% QoQ, first-ever wage delay, top-2-client revenue shock, Q4 turnaround guided.',
    trigger: 'Delivery-backed move with no corroborating positive announcement; filing category mislabeled.',
    trigger_quantified: 'Only "strong" filing: Collector of Stamps penalty of ₹1,23,14,040 on KPIT + Birlasoft for a 4-day delay in lodging the NCLT demerger order (received Aug 26, 2026) — immaterial and not order-related despite the order_book category tag. No fresh order win disclosed. Underlying concall (Jul 29) was Cautious with a wage delay and client concentration shock flagged.',
    linkage: 'mismatched',
    contextUsed: [],
    concallCorroboration: null,
  },
  ...
  },
  {
    ...
    trigger: 'Follow-up compliance filing on an already-disclosed preferential issue; underlying deal terms not in this PDF.',
  ...
  },
  {
    ...
    linkage: 'explained',
    contextUsed: [],
    concallCorroboration: cc(true, { sentiment: 'Optimistic', resultQualityScore: 76.7, highlights: ['First international 5G shipments', 'BSNL 26k-site expansion imminent — now partially confirmed via ₹1,537 Cr TCS LOI for 18,685 sites', '12–18 month profitability timeline'] }),
  },
  {
    companyId: 'NSE:MVELECTRO',
    tier: 'ACT',
    research_axis: 'DELIVERY_VALUE',
    summary: 'MV Electrosystems +11.25% on low 5.2% delivery but large value (₹105.3 Cr of ₹2,037.3 Cr traded, 7.1x volume). Category tag "management_change" is a mismatch: the PDF read is the routine Aug 25 board meeting outcome (Q1FY27 unaudited results, secretarial/internal auditor appointments, AGM notice for Sep 29) — it does not contain the change-in-management disclosure itself, which is a separate filing not in the strong list. Concall from Aug 27 (only 3 days old) was Optimistic, resultQualityScore just 21.6: production ramp to 40/month by January, 10%+ PAT margin target, EMU approval 15-16 months away.',
    trigger: 'Delivery-backed move around a fresh, very recent Optimistic concall plus routine board outcome; the actual management-change filing driving the category tag was not captured in this PDF.',
    ...
    linkage: 'mismatched',
    contextUsed: [],
    concallCorroboration: cc(true, { sentiment: 'Optimistic', resultQualityScore: 21.6, highlights: ['Production ramp to 40/month by January', '10%+ PAT margin target', 'EMU approval still 15-16 months away'] }),
  },
  {
    companyId: 'NSE:MANINFRA',
    tier: 'WATCH',
    research_axis: 'DELIVERY_VALUE',
    summary: 'Man Infraconstruction +6.37% at 52-week high on 42.9% delivery (₹38.4 Cr of ₹89.5 Cr traded, 3.0x volume, RSI 71 overbought). No STRONG-filing PDF was read (announcements_to_read empty) — evidence shows a buyback board-meeting intimation, an investor-meet transcript/outcome, and an AGM postal-ballot notice, but these were classified as supporting-only. Concall just 9 days old was Bullish (resultQualityScore 63.7).',
    trigger: 'Unexplained delivery-backed move; buyback intimation and a very recent Bullish concall are the closest corroborating context.',
    ...
    linkage: 'unexplained',
    contextUsed: [],
    concallCorroboration: cc(true, { sentiment: 'Bullish', resultQualityScore: 63.7, highlights: ['₹6,600cr GDV launch pipeline', '₹3,000cr three-year cash generation guided', 'Tardeo 2.0 launch pulled forward'] }),
  },
  {
    companyId: 'NSE:NAZARA',
    tier: 'WATCH',
    research_axis: 'DELIVERY_VALUE',
    summary: 'Nazara Technologies +5.67% at 52-week high on 40.7% delivery (₹121.3 Cr of ₹298.3 Cr traded, 2.7x volume, RSI 74 overbought). No STRONG-filing PDF read — only an EGM outcome and a generic Reg 30 disclosure in supporting list. Concall 26d old was Optimistic (resultQualityScore only 18.2 — low despite the label).',
    trigger: 'Unexplained delivery-backed move at a 52-week high; EGM outcome and prior M&A guidance are the closest context.',
    ...
    linkage: 'unexplained',
    contextUsed: [],
    concallCorroboration: cc(true, { sentiment: 'Optimistic', resultQualityScore: 18.2, highlights: ['Moonshine investment fully written off', '$303mn Bluetile all-cash acquisition', 'Raymond Stauffer appointed Group CEO'] }),
  },
  {
    companyId: 'NSE:JTLIND',
    tier: 'WATCH',
    research_axis: 'DELIVERY_VALUE',
    summary: 'JTL Industries +8.84% at 52-week high on 32.6% delivery (₹53.4 Cr of ₹164.0 Cr traded, 6.6x volume, RSI 75 overbought). No STRONG-filing PDF read — investor-meet intimation and a press release are supporting-only. Concall 25d old was Optimistic (resultQualityScore 80.3, the strongest in this batch).',
    ...
    linkage: 'unexplained',
    contextUsed: [],
    concallCorroboration: cc(true, { sentiment: 'Optimistic', resultQualityScore: 80.3, highlights: ['Record volume, revenue, EBITDA', 'Defence revenue guidance cut', 'Primary-secondary spread guided ₹8–12/kg'] }),
  },
  {
    companyId: 'NSE:EXICOM',
    tier: 'WATCH',
    research_axis: 'DELIVERY_VALUE',
    summary: 'Exicom Tele-Systems +7.55% on 30.9% delivery (₹27.4 Cr of ₹88.5 Cr traded, 4.0x volume). No STRONG-filing PDF read — annual report dispatch and AGM notice are routine/supporting only. Concall 20d old was Neutral (resultQualityScore 67.3).',
  ...
  },
  {
    ...
    tier: 'WATCH',
    research_axis: 'DELIVERY_PCT',
    summary: 'Syncom Formulations +12.23% on 22.7% delivery (₹25.2 Cr of ₹110.8 Cr traded, 7.0x volume, RSI 81 heavily overbought). No announcements and no concall data at all.',
  ...
  },
  {
    ...
    tier: 'WATCH',
    research_axis: 'DELIVERY_VALUE',
    summary: 'Newgen Software +8.43% on 15.4% delivery (₹90.8 Cr of ₹588.7 Cr traded, 13.7x volume spike). No STRONG-filing PDF read — only an investor-meet intimation (supporting-only). Concall 45d old was Optimistic (resultQualityScore 52).',
    trigger: 'Unexplained delivery-backed move corroborated by dated but Optimistic concall commentary.',
    ...
    linkage: 'unexplained',
    contextUsed: [],
    concallCorroboration: cc(true, { sentiment: 'Optimistic', resultQualityScore: 52, highlights: ['Insurance & healthcare revenue +58%', 'Implementation revenue down 23%', 'Board evaluating share buyback'] }),
  },
  {
    companyId: 'NSE:MASTEK',
    tier: 'WATCH',
    research_axis: 'DELIVERY_VALUE',
    summary: 'Mastek +17.98% at 52-week high on low 6.5% delivery but huge volume spike (₹65.0 Cr of ₹1,002.9 Cr traded, 73.7x volume — the highest multiple in this batch). No STRONG-filing PDF read — an investor-meet intimation and its own cancellation are supporting-only. Concall 39d old was Neutral (resultQualityScore 51.1).',
    trigger: 'Unexplained, low-delivery, extreme-volume move; investor-meet was intimated then cancelled, an odd combination worth flagging.',
  ...
  },
  {
    ...
    tier: 'WATCH',
    research_axis: 'DELIVERY_PCT',
    summary: 'JG Chemicals +11.24% on 9.4% delivery (₹36.4 Cr of ₹387.9 Cr traded, 5.9x volume). No announcements filed. Concall 20d old was Optimistic (resultQualityScore 73.7).',
    ...
    linkage: 'unexplained',
    contextUsed: [],
    concallCorroboration: cc(true, { sentiment: 'Optimistic', resultQualityScore: 73.7, highlights: ['Record quarterly revenue, EBITDA, PAT', 'Dahej Phase 1 capacity delayed to Q3', 'Lab Pure and JDZRA products launched'] }),
  },
  {
    companyId: 'NSE:OMAXE',
    tier: 'WATCH',
    research_axis: 'DELIVERY_PCT',
    summary: 'Omaxe +16.19% at 52-week high on low 6.8% delivery (₹21.4 Cr of ₹317.4 Cr traded, 7.0x volume, RSI 81 heavily overbought). No announcements and no concall.',
  ...
  },
  {
    ...
    tier: 'WATCH',
    research_axis: 'DELIVERY_PCT',
    summary: 'InfoBeans Technologies +7.13% on 13.2% delivery (₹20.1 Cr of ₹152.0 Cr traded, 42.3x volume — a very extreme spike). No announcements filed. Concall 39d old was Neutral (resultQualityScore 61).',
    trigger: 'Unexplained, extreme-volume move with thin delivery support; concall management declined to guide FY27 revenue.',
  ...
  },
  {
    ...
    tier: 'WATCH',
    research_axis: 'DELIVERY_VALUE',
    summary: 'Exide Industries +1.56% (mild move) on 40.2% delivery (₹108.9 Cr of ₹271.1 Cr traded) — high delivery ratio but small price move. No STRONG-filing PDF (empty list). Concall 27d old was Cautious (resultQualityScore 63).',
